...
export const metadata = {
  ...
  description:
    "Apex Coverage is a modern, customer-first agency focused on providing coverage to real drivers. Learn our story, values, and how we can serve you.",
  openGraph: {
    title: "About Apex Coverage",
    description:
      "A modern, customer-first agency built for people who love to drive.",
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 md:py-20">
          ...
          <p className="mt-4 max-w-3xl text-gray-600">
            ...
            guidance that helps you protect what you have built - your car, your
        ...
        <div className="max-w-7xl mx-auto px-4 py-14 grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2 grid sm:grid-cols-2 gap-4">
            {[
              ...
              { t: "Privacy by default", d: "Your data is encrypted and respected. We do not sell your information." },
            ].map((v) => (
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-3 text-gray-600">
              ...
              way to get covered on the vehicles they care about. We blend
              modern online tools with certified, local expertise so you can
      ...
      <section className="border-t bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10">
          <div>
            ...
            <p className="mt-3 text-gray-600">
              We are here to help. Our team is ready to assist with quotes,
